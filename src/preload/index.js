...
const api = {
  ...
  randomEan13: () => ipcRenderer.invoke('products:random-ean13'),
  getProductEan13: (id) => ipcRenderer.invoke('products:ean-for-id', id),
  getFormulaEan13: (id) => ipcRenderer.invoke('formulas:ean-for-id', id),
  randomFormulaEan13: () => ipcRenderer.invoke('formulas:random-ean13'),
  regenerateProductBarcodes: () => ipcRenderer.invoke('products:regenerate-barcodes'),
